    ...
    <div class="row-fluid">
		...
		<h2>Gestão de Videos</h2>  <br/>
            <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <?php 
				   $id = $_GET['edit'];
		$selecionaVideo = mysql_query("SELECT * FROM videos WHERE id_video = '$id'") or die (mysql_error());
		$query = mysql_fetch_array($selecionaVideo);
		...
		$editar_video = mysql_query("UPDATE videos SET titulo_video = '$titulo', thumb = '$img', descricao_video = '$descricao', data = '$data', autor = 'autor' WHERE id_video = '$id'") or die(mysql_error());
		if($editar_video){
			...
			echo "<button type='button' class='close' data-dismiss='alert'>&times;</button>";
			echo "Falha ao iatualizar vídeo!";
			echo "</div>";		
		}
	}	
	?>
            ...
            <label>
            	<h5>Url do Video</h5>
                <input class="input-xxlarge" type="text" placeholder="Url do Video" value="<?php echo($query['codigo']) ?>" name="url" maxlength="59" rows="5"/>
            </label>
            <br/>       
        	<label>
            	<h5>Título</h5>
                <input class="input-xxlarge" type="text" placeholder="Título do Video" name="titulo" value="<?php echo($query['titulo_video']) ?>" maxlength="59" rows="5"/>
            </label>
            ...
            <label>
            	<h5>Imagem</h5>
            	<input class="input-xxlarge" type="text" placeholder="URL da Imagem" value="<?php echo($query['thumb']) ?>" name="imagem"/>
            </label>
            ...
            <label>
            	<h5>Descrição</h5>
                <textarea name="descricao" rows="4" value="<?php echo($query['descricao_video']) ?>" cols="50"></textarea>
            </label>
                
            	<br/>
            
            <h5>Data</h5>
                <input class="input-medium" type="text" name="data" value="<?php echo($query['data']) ?>"/>
               <br/>
               
            <h5>Autor</h5>
            	<input class="input-medium" type="text" name="autor" value="<?php echo($query['autor']) ?>"/> 
               <br/>
               <br/>
            ...
            <a href="list_videos.php" class="btn btn-large">Cancelar</a>
