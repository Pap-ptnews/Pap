...
<html lang="en">
          ...
          <div class="nav-collapse collapse">
            ...
            <?php
				 if(isset($_SESSION['UsuarioNome'])) {
                        ...
                        echo '<li><a href="user.php" ><i class="icon-user"> </i>&nbspPerfil</a>Perfil</a></li>';
  ...
  <div class="span6">
	 ...
	 <div class="well">
  	 	...
  	 	<label>
            	<h5>Username</h5>
                <input class="input-large" type="text" placeholder="Username" name="username" maxlength="59" rows="5"/>
            </label>
              
            <label>
            	<h5>Email</h5>
                <input class="input-large" type="text" placeholder="Email" name="email" maxlength="59" rows="5"/>
            </label>
              
            <label>
            	<h5>Password</h5>
                <input class="input-large" type="password" placeholder="Password" name="password" maxlength="59" rows="5"/>
            </label>
          <br />  
            <input type="hidden" name="acao" value="enviar"/>
            <button class="btn btn-inverse btn-large" type="submit">Registar</button> 
